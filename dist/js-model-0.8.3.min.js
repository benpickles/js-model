 ...
 */
var Model=function(a,b,c){b=b||{};c=c||{};var d=function(e){this.attributes=e||{};this.changes={};this.errors=new Model.Errors(this)};jQuery.extend(d,Model.Callbacks,Model.ClassMethods,b,{_name:a,collection:[],chain:function(e){return jQuery.extend({},this,{collection:e})}});jQuery.extend(d.prototype,Model.Callbacks,Model.InstanceMethods,c);return d};
Model.Callbacks={callbacks:{},bind:function(a,b){this.callbacks[a]=this.callbacks[a]||[];this.callbacks[a].push(b);return this},trigger:function(a,b){if(a=this.callbacks[a])for(var c=0;c<a.length;c++)a[c].apply(this,b||[]);return this},unbind:function(a,b){if(b)for(var c=this.callbacks[a]||[],d=0;d<c.length;d++)c[d]===b&&this.callbacks[a].splice(d,1);else delete this.callbacks[a];return this}};
